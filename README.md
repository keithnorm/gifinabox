# Hello Just Name it Beansnappers!
...
~~~sh
git clone git@github.com:nko3/just-name-it-beansna.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-just-name-it-beansna --password tKaGLMGfXr/2N7Ul
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/just-name-it-beansna" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280793
[3]: https://github.com/nko3/just-name-it-beansna
